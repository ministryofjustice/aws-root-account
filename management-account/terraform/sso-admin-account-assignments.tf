  ...
  sso_admin_account_assignments = [
    ...
    },
    {
      ...
      account_ids = [
        ...
        aws_organizations_account.hmpps_victim_case_management_system_stage.id,
    ...
    },
    {
      ...
      account_ids = [
        ...
        aws_organizations_account.electronic_monitoring_monitoring_and_mapping_pre_prod.id,
        aws_organizations_account.electronic_monitoring_monitoring_and_mapping_prod.id,
        aws_organizations_account.electronic_monitoring_monitoring_and_mapping_test.id,
