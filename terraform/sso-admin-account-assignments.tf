  ...
  teams_to_account_assignments = [
    ...
    },
    {
      ...
      accounts = [
        ...
        aws_organizations_account.opg-modernising-lpa-development,
        aws_organizations_account.opg-modernising-lpa-preproduction,
        aws_organizations_account.opg-modernising-lpa-production,
